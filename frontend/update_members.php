...
if (isset($_POST["update_member"])) {
    ...
    $up_sql = "UPDATE `members` SET `fname`='$up_fname',`sname`='$up_sname',`username`='$up_username',`email`='$up_email',`phone`='$up_phone'  WHERE id ='$id'";
    ...
    if ($up_result) {
        ...
        echo "<a class='btn btn-primary col-md-4' href='members.php'>BACK</a>";
        echo "</div>";
    } else {
                            ...
                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row p-2">
                                    <div class="col-md-12">
                                        ...
                                        <input class="btn btn-primary col-md-4" type="submit" name="update_member" value="UPDATE">
